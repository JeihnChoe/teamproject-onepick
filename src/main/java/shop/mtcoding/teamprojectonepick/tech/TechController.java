...
public class TechController {
    ...
    // public @ResponseBody ApiUtil<String> save(@RequestBody ReplyRequest.SaveDTO
    // saveDTO) { // @RequestBody이면 json데이터로
    // // 받는다. 안적었으면
    ...
    // if (sessionUser == null) {
    // // return new ApiUtil<String>(false, "인증이 되지 않았습니다."); // 일관성 깨짐. throw 날리는걸로
    // // 해야됨.
