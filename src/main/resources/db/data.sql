...
insert into resume_tb(title, semi_content, content, education, school, major, career1, career_period1, career_period1_1, career2, career_period2, career_period2_1, career3, career_period3, career_period3_1, open, etc1, etc2, etc3, etc_period1, etc_period2, etc_period3, link1, link2, link3, workField, user_id) 
...
insert into resume_tb(title, semi_content, content, education, school, major, career1, career_period1, career_period1_1, career2, career_period2, career_period2_1, career3, career_period3, career_period3_1, open, etc1, etc_period1, etc2, etc_period2, etc3, etc_period3, link1, link2, link3, workField, user_id) 
...
insert into resume_tb(title, semi_content, content, education, school, major, career1, career_period1, career_period1_1, career2, career_period2, career_period2_1, career3, career_period3, career_period3_1, open, etc1, etc2, etc3, etc_period1, etc_period2, etc_period3, link1, link2, link3, workField, user_id) 
values('저는 서울대학교 재학중인 학생입니다.', '-서울대생-', '저는 서울대생입니다.','안녕하십니까, 저는 제목으로만 말하겠습니다. 이상입니다.', '대학교 졸업', '서울대학교', '컴퓨터공학과', '신입', null, null, null, null, null, null, null, null, false, '없음', '없음', '없음', null, null, null,'http://www.naver.com' ,null ,null, '백엔드 개발자', 3);
...
insert into user_tb(resume_id, tech_id) values('1', '1');
insert into user_tb(resume_id, tech_id) values('1', '4');
insert into user_tb(resume_id, tech_id) values('2', '3');
insert into user_tb(resume_id, tech_id) values('2', '6');
insert into user_tb(resume_id, tech_id) values('2', '7');
insert into user_tb(resume_id, tech_id) values('3', '3');
